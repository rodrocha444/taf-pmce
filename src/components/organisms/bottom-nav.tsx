  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-zinc-950/85 backdrop-blur-xl border-t border-zinc-800/80 px-2 py-2 flex items-center justify-around max-w-xl mx-auto bottom-nav-safe text-center shadow-2xl shadow-black">
        <Link
          to="/workouts"
          className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-2xl text-[9px] font-bold transition-all duration-300 relative ${isActive('/workouts')
        ...
        <Link
          to="/exercises"
          className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-2xl text-[9px] font-bold transition-all duration-300 relative ${isActive('/exercises')
              ? 'text-amber-400 bg-amber-500/15 border border-amber-500/30 shadow-md shadow-amber-500/10 scale-105'
              : 'text-zinc-400 hover:text-white border border-transparent'
            }`}
        >
        ...
        <Link
          to="/running"
          className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-2xl text-[9px] font-bold transition-all duration-300 relative ${isActive('/running')
              ? 'text-amber-400 bg-amber-500/15 border border-amber-500/30 shadow-md shadow-amber-500/10 scale-105'
              : 'text-zinc-400 hover:text-white border border-transparent'
            }`}
        >
        ...
        <Link
          to="/history"
          className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-2xl text-[9px] font-bold transition-all duration-300 relative ${isActive('/history')
              ? 'text-amber-400 bg-amber-500/15 border border-amber-500/30 shadow-md shadow-amber-500/10 scale-105'
              : 'text-zinc-400 hover:text-white border border-transparent'
            }`}
        >
        ...
        <Link
          to="/reports"
          className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-2xl text-[9px] font-bold transition-all duration-300 relative ${isActive('/reports')
              ? 'text-amber-400 bg-amber-500/15 border border-amber-500/30 shadow-md shadow-amber-500/10 scale-105'
              : 'text-zinc-400 hover:text-white border border-transparent'
            }`}
        >
